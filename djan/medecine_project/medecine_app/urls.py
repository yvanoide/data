...
urlpatterns = [
    ...
    path('delete_dataset/<str:collection_name>/', views.delete_dataset, name='delete_dataset'),  # Vue de suppression
    path('delete_json_collection/<str:collection_name>/', views.delete_json_collection, name='delete_json_collection'),
    path('delete_video/<str:video_id>/', views.delete_video, name='delete_video'),
    path('recherche-bloques-texte/', views.recherche_bloques_texte, name='recherche_bloques_texte'),
    path('transfert_texte/', views.transfert_texte, name='transfert_texte'),
    path('message/', views.message_view, name='message'),  # Define URL pattern for 'message'
    path('download_text/<str:bloc_id>/', views.download_file, name='download_text'),  # Utilisation de download_file
